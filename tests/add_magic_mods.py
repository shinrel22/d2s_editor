...
for item in char.items:
    ...
    for mod_data in [
        # dict(mod_id=get_mod_id_by_code('indestructible'), values=dict(value=1)),

        # dict(mod_id=get_mod_id_by_code('add_skill'), values=dict(skill_id=869, skill_level=1000)),

        # dict(mod_id=get_mod_id_by_code('+_all_skill_level'), values=dict(value=3)),
        # dict(mod_id=get_mod_id_by_code('+_class_skill_level'), values=dict(class_id=4, skill_level=1)),
        ...
        # dict(mod_id=get_mod_id_by_code('+_life'), values=dict(value=50)),

        # dict(mod_id=get_mod_id_by_code('+_strength'), values=dict(value=500)),
        # dict(mod_id=get_mod_id_by_code('+_vitality'), values=dict(value=40)),
        # dict(mod_id=get_mod_id_by_code('+_dexterity'), values=dict(value=100)),
        ...
        # dict(mod_id=get_mod_id_by_code('+%_energy'), values=dict(value=2)),

        # dict(mod_id=get_mod_id_by_code('+_spell_focus'), values=dict(value=15)),
        #
        ...
        # dict(mod_id=get_mod_id_by_code('+%_phy_mag_spell_dmg'), values=dict(value=2)),
